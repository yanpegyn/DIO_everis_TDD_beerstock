...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Yan Pegyn";
    private static final String CONTACT_GITHUB = "https://gtihub.com/yanpegyn";
    private static final String CONTACT_EMAIL = "yanpegyn@gmail.com";
